            ...
            <form action="checkout.php" method="post">
                            ...
                            ?>
                                    <tr class="cart-item">
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <a href="" class="remove" data-product-id="<?php echo $row['product_id']; ?>">Remove</a>
                                        </td>
                                        <td class="price">R<?php echo $row['price']; ?></td>
                                        <input type="hidden" name="price" value="<?php echo $row['price']; ?>" class="item-price">
                                        <input type="hidden" name="product_id" value="<?php echo $row['product_id']; ?>" class="product-id">
                                        <td><?php echo $size ?></td>
                                        <td class="quantity">
                                            <input type="number" class="item-quantity" name="quantity" min="1" max="" value="<?php echo $quantity; ?>" required />
                                        </td>
                                        <td class="price total">R<?php echo $quantity * $row['price'] ?></td>
                                    </tr>
                            <?php
                                }
                            }
                ...
                <?php if (!$cartIsEmpty) { ?>
                    ...
                    <div class="subtotal">
                        ...
                        <span id="subtotal">R<?php echo calculateSubtotal($cart, $con); ?></span>
                    </div>
                    <div class="buttons">
                        <button type="button" name="update" id="update-btn">Update Cart</button>
